...
void node_dynnamics(int U,int *matrix, int *list_states, int N, int node){
    ...
    if (number_neighboors>0){
        ...
        if( (*(list_states+node)-*(list_states+index_neighboors[node_2]))<=U ){
...
void evolution(int U, float d,float r,int *matrix, int *list_states,int N,int n_evol){
...
void main(){
    ...
    print_matrix(matrix,N,"matrix_representation_ND_i.dat");
    print_states(list_states,N,"states_ND_i.dat");
    evolution(U,d,r,matrix,list_states, N,T_steps);
    print_matrix(matrix,N,"matrix_representation_ND_f.dat");
    print_states(list_states,N,"states_ND_f.dat");
