...
void evolution(float d, float r, int *matrix, int *list_states,int N,int n_evol,float *densities){
...
void main(){
    ...
    while(run<runs){
        ...
        print_states(list_states,N,"states");
        printf("p used %f\n",p);
        ...
        evolution(d,r, matrix,list_states, N,T_steps,densities);
